...
void ViveSR_DualCameraImageCapture::Initial()
{
    ...
    if (is_gpu_path) {
        if (img4K_ready) {
            ...
            distorted_texture_right = UTexture2D::CreateTransient(distorted_img_width, distorted_img_height, EPixelFormat::PF_B8G8R8A8);
        }
        else {
            distorted_texture_left = UTexture2D::CreateTransient(distorted_img_width, distorted_img_height, EPixelFormat::PF_R8G8B8A8);
